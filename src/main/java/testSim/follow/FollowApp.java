    ...
    public List<Object> callStarL() {
        ...
        while(true) {
		    ...
		    String line;
                        ...
                        catch (NoSuchElementException e) {stage = Stage.DONE;lineno = lineno - 1;}
                        catch (IllegalArgumentException e) {stage = Stage.DONE;lineno = 0;}
                    if(destinations.isEmpty()||robotIndex == 0) {
						...
						wait0 = true;
						System.out.println("here"+robotIndex);
                                                break;
					}
